...
**InvalidPackageId**: the unit reports a usage error when the package argument equals `SPDXRef-DOCUMENT`.
This scenario is tested by `CopyPackage_Run_InvalidPackageId_ReportsError`.
