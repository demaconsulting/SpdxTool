...
This document contains the build notes for SpdxTool.

## Purpose

This document provides a record of the changes, new features, and bug fixes included
in this release of SpdxTool. It also records the versions of all tools used in the
build pipeline, providing traceability between the software artifacts and the
